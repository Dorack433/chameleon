...
user_pref("privacy.clearOnShutdown.offlineApps", true);
   user_pref("privacy.clearOnShutdown.siteSettings", true); // [DEFAULT: false] Site Preferences
...
user_pref("privacy.cpd.offlineApps", true);
   ...
   user_pref("privacy.cpd.passwords", true); // [DEFAULT: false] this is not listed
   user_pref("privacy.cpd.siteSettings", true); // [DEFAULT: false] Site Preferences
